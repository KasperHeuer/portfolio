<x-math-tool-layout>
    <x-math-tool name="Collatz Sequence Calculator">
        <x-math-tool-explanation>
            <b> What is the Collatz Conjecture?</b><br>
            The Collatz conjecture states that if we take any positive integer and apply the following rules repeatedly,
            we'll always reach 1:
    ...
    @if (isset($result))
        <!-- Chart container UNDER the tool -->
        <div class="w-full max-w-6xl mx-auto mt-8 px-4 sm:px-6 lg:px-0">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const pointBackgroundColors = sequence.map(v => v === maxValue ? 'rgba(220,53,69,1)' : 'rgba(54,162,235,0.9)');
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                tooltip: {
                                    ...
                                    padding: 10,
                                    callbacks: {
                                        title: function(context) { return 'Step ' + context[0].label; },
                                        label: function(context) { return 'Value: ' + context.parsed.y; }
                                    }
                                }
                            },
                            scales: {
                                x: {
                                    title: { display: true, text: 'Step', color: '#374151', font: { weight: 'bold' } },
                                    ticks: { color: '#4B5563', font: { size: 12 } },
                                    grid: { color: 'rgba(0,0,0,0.05)' }
                                },
                                y: {
                                    title: { display: true, text: 'Value', color: '#374151', font: { weight: 'bold' } },
                                    ticks: { color: '#4B5563', font: { size: 12 } },
                                    grid: { color: 'rgba(0,0,0,0.05)' },
                                    beginAtZero: false
                                }
