<x-layout title='Projects'>
    <div class="flex flex-col gap-10 my-5 mb-20">
        ...
        <div
            ...
            <img src="{{ asset('images/marth.png') }}" alt="Math image"
                class="bg-gray-500/50
                       flex-1
                       w-full
                       max-w-full lg:max-w-[1000px]
            ...
            <div class="flex-1 lg:ml-12 max-w-[600px] text-center lg:text-left">
                <a href="{{ url('/math/home') }}" class="text-white font-serif text-[45px] block underline">
                    Wiskunde in code
                </a>
        ...
        h-auto lg:h-[300px]">
            ...
            <img src="{{ asset('images/blackjack.jpg') }}" alt="Blackjack logo"
                class="bg-gray-500/50
           flex-1
           w-full
           max-w-full lg:max-w-[1000px]
           ...
           object-contain">
            ...
            <div class="flex-1 lg:ml-12 max-w-[600px] text-center lg:text-left">
                <a href="{{ url('/casino/home') }}" class="text-white font-serif text-[45px] block underline">
                    Casino in code
                </a>
