...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col justify-between px-4 py-16 sm:py-24 lg:py-32">
        <div class="w-full max-w-7xl mx-auto flex flex-col items-center">
            
            <!-- HEADER -->
            <header class="text-center mb-20 sm:mb-28">
                <h1
                    class="text-5xl sm:text-6xl lg:text-8xl font-black tracking-tight bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent mb-6">
                    Math Tools
                </h1>
                <p class="mt-8 text-xl sm:text-2xl md:text-3xl text-gray-600 font-light max-w-3xl mx-auto">
